...
class ExceptionHierarchyTest extends TestCase
{
    ...
    public static function exceptionWithCategoryProvider(): array
    {
        return [
            ...
            'CarCreationException' => ['CarCreationException', 'CarErrors'],
            'CarValidationException' => ['CarValidationException', 'ValidationError'],
            'CarDeletionException' => ['CarDeletionException', 'CarErrors'],
            'CarMergeException' => ['CarMergeException', 'CarErrors'],
            'CarTransferException' => ['CarTransferException', 'CarTransferError'],
            'OwnerNotFoundException' => ['OwnerNotFoundException', 'OwnerErrors'],
            'OwnerCreationException' => ['OwnerCreationException', 'OwnerErrors'],
            'OwnerValidationException' => ['OwnerValidationException', 'ValidationError'],
            'OwnerUpdateException' => ['OwnerUpdateException', 'OwnerErrors'],
