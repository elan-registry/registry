...
test('authenticate non-admin', async ({ page }) => {
  if (!process.env.E2E_DEV_NONADMIN_USERNAME || !process.env.E2E_DEV_NONADMIN_PASSWORD) {
    ...
    test.skip(true, 'Set E2E_DEV_NONADMIN_USERNAME and E2E_DEV_NONADMIN_PASSWORD in .env.local to run non-admin authenticated tests');
  }
