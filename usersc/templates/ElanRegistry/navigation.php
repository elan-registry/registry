...
?>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    <a href="<?= $us_url_root ?>"><img src="<?= $us_url_root ?>usersc/templates/ElanRegistry/assets/images/Lotus-logo-40x40.png" alt="Lotus Elan Registry" width="40" height="40"></a>
  ...
  if ($settings->navigation_type == 0) {
    ...
    <div class="" style="background-color: #023c73;">
      <div class="text-center">
        <a style="left:-35px;position: relative;" href="<?= $us_url_root ?>"><img width="40" height="40" alt="Lotus Elan Registry" src="<?= $us_url_root ?>usersc/templates/ElanRegistry/assets/images/Lotus-logo-40x40.png"></a>
      </div>
    </div>
  <?php }
  if ($settings->navigation_type == 1) {
  ...
  if ($settings->navigation_type == 0) {
    ...
    <body>
      ...
      <div class="" style="background-color: #023c73;">
        <div class="text-center">
          <a style="right:-35px;position: relative;" href="<?= $us_url_root ?>"><img width="40" height="40" alt="Lotus Elan Registry" src="<?= $us_url_root ?>usersc/templates/ElanRegistry/assets/images/Lotus-logo-40x40.png"></a>
        </div>
      </div>
    <?php }
  if ($settings->navigation_type == 1) {
