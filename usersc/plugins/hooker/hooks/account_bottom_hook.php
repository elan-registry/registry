...
$formatDate = static fn(string $date, string $format = 'F j, Y'): string
...
<div class="card registry-card">
    <div class="card-header card-header-er-primary">
        <h4 class="mb-0 card-header-er-primary-text"><i class="fas fa-car"></i> <strong>Your Car Information</strong></h4>
    </div>
    <div class="card-body">
        <?php
        ...
        ?>
            <div class="text-center py-5">
                ...
                <a class="btn btn-primary btn-lg" href="<?= $us_url_root ?>app/cars/form.php" role="button">
            ...
            ?>
                <!-- Car Hero Section -->
                <div class="card registry-card bg-primary text-white mb-4" style="border-top: 5px solid var(--er-accent);">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h3 class="mb-0 card-header-er-primary-text">
                        ...
                        <div class="card registry-card">
                            ...
                            <div class="card-body">
                                ...
                                <dl class="row mb-4">
                                    ...
                                    <dd class="col-sm-8"><?= $formatDate($carData->purchasedate) ?></dd>
                                    <?php } ?>

                                    <?php if (!empty($carData->solddate)) { ?>
                                    <dt class="col-sm-4 text-muted">Sold Date</dt>
                                    <dd class="col-sm-8"><?= $formatDate($carData->solddate) ?></dd>
                                    <?php } ?>
                                ...
                                <div class="row text-center">
                                    <div class="col-6">
                                        <i class="fas fa-plus-circle text-primary d-block mb-1"></i>
                                        <small class="text-muted d-block">Added to Registry</small>
                                        <strong><?= $formatDate($carData->ctime, 'M j, Y') ?></strong>
                                    </div>
                                    <div class="col-6">
                                        <i class="fas fa-edit text-primary d-block mb-1"></i>
                                        <small class="text-muted d-block">Last Updated</small>
                                        <strong><?= $formatDate($carData->mtime, 'M j, Y') ?></strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card registry-card">
                            ...
                            <div class="card-body">
                                ...
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-7">
                                        <?= $factoryData->builddate
                                            ? $formatDate($factoryData->builddate)
