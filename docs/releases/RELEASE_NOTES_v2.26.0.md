...
- **Extract coordinate casting helper** ([#831](https://github.com/unibrain1/elanregistry/issues/831)): Consolidates coordinate casting and `syncLocationToCars()` usage in `user_settings.php`, removing duplicated inline logic.
...
- [#831](https://github.com/unibrain1/elanregistry/issues/831) — REFACTOR: Extract coordinate casting helper and use syncLocationToCars() in user_settings.php
